"""WP15-only admitted compile<=300s/simulate<=1200s; original resource controls."""
import argparse
...
from qwen38.wp15_admission import verify as verify_wp15_admission
...
def main():
    ...
    max_seconds = 1200  # Only WP15; exact compile/simulate caps verified below.
    ...
    if args.spec.resolve() != work/'steps.json':
        raise ValueError('Only the frozen WP15 specification is admissible')
    spec = json.loads(args.spec.read_text())
    verify_wp15_admission(work, spec, args.admission)
