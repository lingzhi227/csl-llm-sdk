"""Freeze the gated RMS CPU source-body fixtures; no install, download or execution."""
import argparse
import hashlib
import json
...
def prepare(root, run, sources, interpreter):
    ...
    shutil.copyfile(root/'examples/wp07/build_reference.py', run/'build_reference.py')
