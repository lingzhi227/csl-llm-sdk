...
See [status](STATUS.md) and the [WP01 GEMV report](WP01-REPORT.md) for
qualified scope, bounded original-weight acquisition and synthetic reproduction.
The [WP02 report](WP02-REPORT.md) covers the two-PE chain and its resource ledger.
...
Use the reviewed SDK image identified in [WP00 results](WP00-REPORT.md).
