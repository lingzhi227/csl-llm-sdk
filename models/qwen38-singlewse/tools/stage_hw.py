...
SOURCE="/srv/model-storage/qwen38-singlewse/runs/fp8-tile-sim-004"
DEST="/srv/qwen38-singlewse-hardware/fp8-tile-hw-001"
SESSION=["sh","/path/to/alcf-session.sh","host"]


def main():
    files={n:(ROOT/"experiments"/n).read_bytes() for n in ["layout.csl","pe.csl","run.py"]}
    files["fp8_gemv.csl"]=(ROOT/"csl/fp8_gemv.csl").read_bytes()
    ...
    names=["layout.csl","pe.csl","fp8_gemv.csl","run.py","backend.py"]
    ...
    out=ROOT/"evidence/fp8-tile-hw-001";out.mkdir()
