    ...
    try:
        ...
        for item in operations:
            ...
            if direction == 'd2h':
                ...
                boundary = (name=='tile_guard_snapshot' and pe in (1,3)) or (item['phase']=='reset_observation' and name=='mlp_product' and pe==3) or (item['phase'] in ('initialize_epoch0','retention_after_down','released_join') and name=='lifecycle_state' and pe==3) or (item['phase']=='resident_weights_before_generation1' and pe==1)
                if boundary:
