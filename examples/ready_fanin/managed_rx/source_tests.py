...
def main():
    ...
    print(json.dumps(dict(passed=True,positive=2,negative=len(cases),partial_first_error=1,transport_delta_exact=True,internal_frame_words=32,declared_frame_bytes=128,device_buffer_lifetime_proven=False,SDK_invocations=0,hardware_invocations=0)))
