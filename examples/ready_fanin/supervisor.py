"""One finite fan-in fixture compile, reusing the accepted owner-correlated job cleanup."""
...
def main():
    ...
    with (ROOT.parent/'hardware.lock').open('a') as lock:
        ...
        try:
            ...
            atomic_json(ROOT/'COMPLETE.json',dict(scope='Concurrent136-producer READY fixture compile only; separate runtime admission required',stages=[receipt],all_owned_jobs_released=True,runtime_created=False,full_model=False))
