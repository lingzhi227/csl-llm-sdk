"""Compile the complete native layer3 graph at original coordinates on an appliance worker; no CS3 runtime."""
...
def main():
    ...
    # Preserve actual fullgraph-role mapping and storage even when SRAM fails.
    ...
    if not passed:raise ValueError('Complete native graph SRAM gate')
    verify()
