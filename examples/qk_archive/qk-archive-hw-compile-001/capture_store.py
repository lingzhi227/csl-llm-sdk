...
SPECS = {f'epoch{epoch}_{kind}': shape for epoch in (1, 2)
         for kind, shape in [('evidence', (4, 64)), ('archive', (1, 960)),
                             ('reference', (1, 960)), ('workspace', (1, 1280)),
                             ('output', (1, 256)), ('baseline_output', (1, 256))]}
SPECS['negative_evidence'] = (4, 64)
