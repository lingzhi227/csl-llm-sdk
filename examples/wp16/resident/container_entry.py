...
from qwen38.resident_sdk_admission import THREAD_ENV, WORK, require, verify, verify_compiled, stage_limits
...
def main():
    require(len(sys.argv) == 2 and sys.argv[1] == 'simulate', 'Exact inner simulation-only SDK stage')
    stage = sys.argv[1]
    ...
    require(outer['source_manifest_sha256'] == digest and outer['stage'] == stage and
            ...
            outer['actual_limits'] == stage_limits(stage),
