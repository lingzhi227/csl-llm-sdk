...
from qwen38.wp16_reuse_sdk_admission import (
        ...
        for step in STEPS['steps']:
            ...
            try:
                ...
                if step['name'] == 'compile':
                    ...
                    require(outcome['status'] == 'connected_reuse_passed' and outcome['normal_stop'] is True, 'All SDK gates and normal stop required')
