...
"""
import faulthandler,hashlib,sys,time
...
class StartupTrace:
    ...
    def callback(self,frame,event,arg):
        ...
        self.store.event('startup_step_'+event,name=name,monotonic=now,
            since_trace_start=now-self.started,active=active)
    ...
    def __enter__(self):
        ...
        self.store.event('startup_trace_enter',monotonic=self.started,
            single_stack_dump_after_seconds=self.profile['startup_stack_after_seconds'])
